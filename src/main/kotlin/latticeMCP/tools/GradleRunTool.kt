...
import latticeMCP.gradle.GradleCommandValidator
import latticeMCP.gradle.GradleWrapperLocator
import latticeMCP.process.ProcessExecutor
...
object GradleRunTool {
    ...
    fun execute(
        ...
        val result = ProcessExecutor.execute(
            ...
            maxCapturedChars = MAX_OUTPUT_CHARS * 4
        )
